...
const char MODE; // moode we are in
...
/******************************************************************
 * void modeSelect()
 * This function allows for the LED display to change 
 * depending on what mode you are in.
/*****************************************************************/
void modeSelect(char mode)
{
  switch(mode)
    case "F":
       fitnessColors();
...
/******************************************************************
 * void fitnessColors()
 * This function allows for the LED display for the fitness mode, which should be a blinking white light that matches heart beat
/*****************************************************************/
void fitnessColors() //this should take bmp as input
{
      //fitness mode
      // all LEDs off
 ...
 * pink nervous
  */
/*****************************************************************/
void moodColors()//this should take bmp as input or temp
{
      //mood mode
  // Red
  digitalWrite(RED_PIN, HIGH);
...
/******************************************************************
 * void productivityColors()
  */
/*****************************************************************/
void productibityColors()//this should take bmp 
{
  //go dark to light blue = breath
 // go dark to light green = exhale
}
